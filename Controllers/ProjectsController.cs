...
namespace MVCApplicationToDo.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Title")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Title")] Project project)
        {
            if (id != project.Id)
            {
                return NotFound();
